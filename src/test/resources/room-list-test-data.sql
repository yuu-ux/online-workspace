...
INSERT INTO users VALUES
    (1, '閲覧者', 'viewer@example.com', NULL),
    (2, '作成者', 'creator@example.com', NULL),
    (3, 'ブロック相手', 'blocked@example.com', NULL),
    (4, '参加者', 'member@example.com', NULL);
INSERT INTO room_categories VALUES (1, '開発', 'ソフトウェア開発', 10);
