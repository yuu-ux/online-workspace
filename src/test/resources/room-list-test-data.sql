...
INSERT INTO users VALUES
    ...
    (3, '参加者2', 'member2@example.com', 1, NULL, NULL),
    (4, '参加者', 'member@example.com', 1, NULL, NULL),
    (5, '作成者2', 'creator2@example.com', 1, NULL, NULL),
...
INSERT INTO rooms (id, name, description, created_by, category_id, work_style_id, max_members, status_id, created_at) VALUES
    (10, '参加可能', '静かに作業します', 2, 1, 1, 3, 1, TIMESTAMP WITH TIME ZONE '2026-08-10 10:00:00+09:00'),
    (12, '終了済み', '終了したルーム', 2, 1, 1, 3, 2, TIMESTAMP WITH TIME ZONE '2026-08-12 10:00:00+09:00'),
    (13, '参加可能2', '雑談できます', 2, 1, 2, 3, 1, TIMESTAMP WITH TIME ZONE '2026-08-13 10:00:00+09:00'),
    (14, '満室', '満員です', 2, 1, 1, 2, 1, TIMESTAMP WITH TIME ZONE '2026-08-14 10:00:00+09:00'),
    (15, '読書ルーム', '読書について話します', 5, 2, 1, 3, 1, TIMESTAMP WITH TIME ZONE '2026-08-09 10:00:00+09:00');
