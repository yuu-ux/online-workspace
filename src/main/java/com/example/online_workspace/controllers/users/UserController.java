...
import com.example.online_workspace.services.UserSearchService.RoomCategory;
...
import com.example.online_workspace.services.UserSearchService.UserProfile;
...
public class UserController {
	...
	public UserProfileResponse getProfile(
		...
		UserProfile profile = service.getProfile(authentication.getName(), userId);
		if (profile.isPublic()) {
			return new PublicUserProfileResponse(
				...
				true,
				profile.bio(),
				profile.workCategory() == null ? null : RoomCategoryResponse.from(profile.workCategory()),
				profile.friendship()
			);
		}
	...
	public sealed interface UserProfileResponse permits PublicUserProfileResponse, HiddenUserProfileResponse {
	}
	...
	public record RoomCategoryResponse(long id, String name, String description, int sortOrder) {
		private static RoomCategoryResponse from(RoomCategory category) {
