    ...
    div([class("mx-auto max-w-3xl")], [
      ...
      div([class("space-y-4")], [
        ...
        section("10. 準拠法・管轄裁判所", [
          "本規約は日本法に準拠します。本サービスまたは本規約に関して紛争が生じた場合、運営者の所在地を管轄する裁判所を第一審の専属的合意管轄裁判所とします。提出前に、運営者の正式な所在地に合わせて見直します。",
        ]),
        section("11. 問い合わせ窓口", [
          "本規約に関する問い合わせは、運営者が別途指定する方法で受け付けます。提出前に、実際の運営者名および問い合わせ先をこの項目に記載します。",
        ]),
      ]),
